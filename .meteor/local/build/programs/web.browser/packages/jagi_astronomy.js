...
class Class {
  constructor() {
    let rawDoc = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  static create(definition) {
    ...
    if (_has(this.classes, className)) {
      warn("Duplicate of the \"".concat(className, "\" class"));
  ...
  static extend(extendDefinition) {
    let onlyModules = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
...
class Module {
  constructor(definition) {
    ...
    if (!Match.test(definition.aliases, Match.Maybe([String]))) {
      throwParseError(["Module aliases has to be an array of strings in the \"".concat(this.name, "\" module")]);
    }
    ...
    _each(['onInitSchema', 'onInitDefinition', 'onInitClass', 'onParseDefinition', 'onApplyDefinition', 'onMergeDefinitions', 'onFinalizeClass'], hookName => {
      ...
      if (!Match.test(definition[hookName], Function)) {
        throwParseError([{
          ...
          'property': hookName
        }, "The \"".concat(hookName, "\" hook has to be a function")]);
      }
...
function deprecated(message) {
  ...
  warn("Deprecation warning: ".concat(message));
}
...
class Type {
  ...
  static create(definition) {
    ...
    if (_has(this.types, type.name)) {
      warn("Duplicate of the \"".concat(type.name, "\" type"));
    }
...
function getListFields() {
  let classOnly = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
...
function setOne(doc, fieldPattern, fieldValue, options) {
  ...
  return traverse(doc, fieldPattern, (nestedDoc, nestedFieldName, field) => {
    ...
    if (!field) {
      ...
      warn("[\"".concat(className, "\" class][\"").concat(fieldPattern, "\" field] ") + 'Trying to set a value of the field that does not exist in the class');
      return;
...
function onInitClass(Class, className) {
  ...
  Class.getMethod = function () {
    deprecated("Methods have been renamed to helpers. Please use the " + "\"".concat(className, ".getHelper\" function."));
  ...
  Class.getMethods = function () {
    deprecated("Methods have been renamed to helpers. Please use the " + "\"".concat(className, ".getHelpers\" function."));
  ...
  Class.hasMethod = function () {
    deprecated("Methods have been renamed to helpers. Please use the " + "\"".concat(className, ".hasHelper\" function."));
...
function onParseDefinition(parsedDefinition, definition, className) {
  if (definition.methods) {
    ...
    deprecated("Methods have been renamed to helpers. Please use the \"helpers\" " + "section in the \"".concat(className, "\" class definition."));

    _each(definition.methods, (method, methodName) => {
      if (_has(definition.helpers, methodName)) {
        deprecated("Methods have been renamed to helpers. Please move the " + "\"".concat(methodName, "\" method to the \"helpers\" section in the ") + "\"".concat(className, "\" class definition."));
      } else {
  ...
  function prefixIndexes(indexes, fieldName) {
    ...
    _each(indexes, (index, indexName) => {
      index.fields = _mapKeys(index.fields, (value, key) => {
        return "".concat(fieldName, ".").concat(key);
      });

      _extend(index.options, {
        name: "".concat(fieldName, ".").concat(indexName)
      });
    }); // Prefix object keys.


    indexes = _mapKeys(indexes, (index, indexName) => {
      return "".concat(fieldName, ".").concat(indexName);
    });
    return indexes;
...
function throwIfSelectorIsNotId(selector, methodName) {
  if (!LocalCollection._selectorIsIdPerhapsAsObject(selector)) {
    throw new Meteor.Error(403, "Not permitted. Untrusted code may only ".concat(methodName, " documents by ID."));
  }
}
...
function parseValidators(validators, parseContext) {
  ...
  _each(validators, function (validator) {
    ...
    if (!_has(Validators, validator.type)) {
      throwParseError(_union(parseContext, ["There is no \"".concat(validator.type, "\" validator")]));
    }
  });
}
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be one of the values ").concat(choices);
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" should be a valid email address");
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" should be equal ").concat(param);
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" should not to be equal ").concat(param);
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" does not match the \"").concat(param.toString(), "\" regular expression");
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" should not be null");
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" should be null");
  }
    ...
    _each(value, function (element, index) {
      ...
      _each(validators, function (validator) {
        ...
        validationFunction({
          ...
          nestedName: "".concat(nestedName, ".").concat(index),
          value: element,
          param: validator.param
        });
      });
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "The \"".concat(name, "\" field does not have the \"").concat(param, "\" property");
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "The \"".concat(name, "\" field does not contain the \"").concat(param, "\" value");
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be greater than ").concat(param);
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be greater than or equal ").concat(param);
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "Length of \"".concat(name, "\" has to be ").concat(param);
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be less than ").concat(param);
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be less than or equal ").concat(param);
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "Length of \"".concat(name, "\" has to be at most ").concat(param);
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "Length of \"".concat(name, "\" has to be at least ").concat(param);
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be an array");
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be a boolean");
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be ").concat(className);
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be a date");
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be an integer");
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be a Mongo.ObjectID");
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be a number");
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be an object");
  }
...
Validator.create({
  ...
  resolveError(_ref2) {
    ...
    return "\"".concat(name, "\" has to be a string");
  }
